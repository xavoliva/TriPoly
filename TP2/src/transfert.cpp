...
ostream & operator<<(ostream & cout, const Transfert & t)
{
	return cout << "Transfert fait par " << t.expediteur_->getNom() << " vers " << t.receveur_->getNom()
		<< " d'un montant de " << t.montant_ << endl;
}
